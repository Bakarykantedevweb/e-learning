                ...
                <div class="col-lg-6 mb-6 mb-lg-0">
                    <div>
                        ...
                        <p class="pe-lg-10 mb-5">
                            Démarrez, changez ou faites progresser votre carrière avec plus de 5 000 cours, certificats professionnels et diplômes d'universités et d'entreprises de renommée mondiale.
                        </p>
                        <!-- btn -->
            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="mb-6">
                        ...
                        <p>Voici les cours les plus populaires parmi les apprenants de LearnX Cours dans le monde entier en 2025
                        </p>
                    </div>
                </div>
            </div>
                        ...
                        <div class="tab-pane fade show active" id="pills-development" role="tabpanel"
                            ...
                            <div class="row row-cols-1 row-cols-md-2 row-cols-lg-4 g-4">
                                ...
                                <div class="col">
                                    <!-- Card -->
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img src="assets/images/course/course-css.jpg"
                                ...
                                <div class="col">
                                    <!-- Card -->
                                    <div class="card card-hover">
                                        <a href="../course-single.html"><img src="assets/images/course/course-gatsby.jpg"
                                                alt="course" class="card-img-top" /></a>
                                        <!-- Card Body -->
                                        <div class="card-body">
                                            <div class="d-flex justify-content-between align-items-center mb-3">
